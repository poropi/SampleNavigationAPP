package jp.ne.poropi.samplenavigationediterapp.fragment
...
import jp.ne.poropi.samplenavigationediterapp.R
...
//        val id = arguments?.getInt("id")
        // safe argsであれば、以下で受け取れる
        val args = SecondFragmentArgs.fromBundle(arguments?:return)
        val name = args.name
        val id = args.id

        textView.text = "${textView.text}${(arguments?.getString("name") ?: "")}"
        button.setOnClickListener {
            val bundle = bundleOf("name" to "taiga")
